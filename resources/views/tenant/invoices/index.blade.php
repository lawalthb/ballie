...
@section('page-description', 'Manage all your invoices and track payments')
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
            <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4">
                <div class="relative">
                    <input type="text" placeholder="Search invoices..." class="pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent">
            ...
            <div class="flex space-x-3">
                ...
                <a href="{{ route('invoices.create') }}" class="px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition-colors">
                    Create Invoice
                </a>
            </div>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @php
                    $invoices = [
                        ['id' => 'INV-2024-001', 'customer' => 'Adebayo Enterprises', 'date' => '2024-01-15', 'due_date' => '2024-02-14', 'amount' => 125000, 'status' => 'paid'],
                        ['id' => 'INV-2024-002', 'customer' => 'Kemi Okafor Ltd', 'date' => '2024-01-16', 'due_date' => '2024-02-15', 'amount' => 85500, 'status' => 'sent'],
                        ['id' => 'INV-2024-003', 'customer' => 'Lagos Trading Co.', 'date' => '2024-01-17', 'due_date' => '2024-02-16', 'amount' => 67200, 'status' => 'overdue'],
                        ['id' => 'INV-2024-004', 'customer' => 'Abuja Supplies', 'date' => '2024-01-18', 'due_date' => '2024-02-17', 'amount' => 92800, 'status' => 'draft'],
                        ['id' => 'INV-2024-005', 'customer' => 'Port Harcourt Ltd', 'date' => '2024-01-19', 'due_date' => '2024-02-18', 'amount' => 156000, 'status' => 'paid'],
                    ];
                    @endphp
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ date('M j, Y', strtotime($invoice['date'])) }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="text-sm text-gray-900">{{ date('M j, Y', strtotime($invoice['due_date'])) }}</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center space-x-2">
                                ...
                                <button class="text-green-600 hover:text-green-900" title="Mark as Paid">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                </button>
