        ...
        <ul class="space-y-2 px-4">
            ...
            <li>
                <a href="{{ route('tenant.accounting.invoices.index', ['tenant' => $tenant->slug]) }}"
                   class="menu-item flex items-center px-4 py-3 rounded-xl group {{ request()->routeIs('tenant.accounting.invoices.*') ? 'active' : '' }}">
                    ...
                    <span class="menu-title whitespace-nowrap font-medium">Invoices</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('tenant.crm.customers.index', ['tenant' => $tenant->slug]) }}"
                   class="menu-item flex items-center px-4 py-3 rounded-xl group {{ request()->routeIs('tenant.crm.customers.*') ? 'active' : '' }}">
                    ...
                    <span class="menu-title whitespace-nowrap font-medium">Customers</span>
                </a>
            </li>
