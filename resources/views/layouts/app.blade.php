                ...
                <div class="flex justify-between items-center h-16">
                    ...
                    <div class="flex items-center">
                        <a href="{{ route('home') }}" class="flex items-center">
                            ...
                            <span class="text-xl font-bold text-brand-blue">Ballie</span>
                        </a>
                    </div>
        ...
        <footer class="bg-gradient-to-br from-brand-dark-purple via-brand-deep-purple to-brand-violet text-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <!-- Support Links -->
                    <div>
                        <h3 class="text-lg font-semibold mb-4 text-brand-gold">Support</h3>
                        <ul class="space-y-2">
                            ...
                            <li><a href="#" class="text-gray-300 hover:text-brand-gold transition-colors">Status</a></li>
