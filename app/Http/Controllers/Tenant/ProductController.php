...
class ProductController extends Controller
{
    ...
    public function show(Tenant $tenant, Product $product)
    {
        ...
        return view('tenant.inventory.products.show', compact('product', 'tenant'));
    }
    ...
    public function edit(Tenant $tenant, Product $product)
    {
        ...
        return view('tenant.inventory.products.edit', compact('product', 'categories', 'units', 'ledgerAccounts', 'tenant'));
    }
    ...
    public function update(Request $request, Tenant $tenant, Product $product)
    {
        ...
        // Update stock value if stock or purchase rate changed
        if ($request->filled('current_stock') && $request->filled('purchase_rate')) {
            $data['current_stock_value'] = $request->current_stock * $request->purchase_rate;
        }
