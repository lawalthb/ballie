...
class VoucherTypeController extends Controller
{
    ...
    {
        // Predefined voucher types that users can choose from
        $primaryVoucherTypes = [
            'journal' => [
            ...
            'payment' => [
                ...
                'code' => 'PV',
                'abbreviation' => 'PV',
                'description' => 'Cash and bank payments to suppliers and expenses',
                'prefix' => 'PV-',
                'has_reference' => true,
                'affects_inventory' => false,
            ...
            'receipt' => [
                ...
                'code' => 'RV',
                'abbreviation' => 'RV',
                'description' => 'Cash and bank receipts from customers and other sources',
                'prefix' => 'RV-',
                'has_reference' => true,
                'affects_inventory' => false,
                'affects_cashbank' => true,
            ...
            'purchase' => [
                ...
                'code' => 'PUR',
                'abbreviation' => 'PUR',
                'description' => 'Purchase invoices and debit notes',
                'prefix' => 'PUR-',
                'has_reference' => true,
                'affects_inventory' => true,
                'affects_cashbank' => false,
            ...
            'contra' => [
                ...
                'code' => 'CV',
                'abbreviation' => 'CV',
                'description' => 'Bank to cash or cash to bank transfers',
                'prefix' => 'CV-',
                'has_reference' => false,
                'affects_inventory' => false,
                'affects_cashbank' => true,
